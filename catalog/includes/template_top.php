...
<link rel="stylesheet" type="text/css" href="stylesheet_freeoscommerce_099.css">
<link rel="stylesheet" type="text/css" href="stylesheet.css" />
<?php echo $oscTemplate->getBlocks('header_tags'); ?>
</head>
<body id="freeoscommerce_099">
...
<?php
  ...
  {
    // replace the quickfind button with "button_quick_find_freeoscommerce_099.gif"
	$boxes_column_left_search_modified = $oscTemplate->getBlocks('boxes_column_left');
	$boxes_column_left_search_modified = str_replace('button_quick_find.gif','button_quick_find_freeoscommerce_099.gif',$boxes_column_left_search_modified);
